...
from HModel.YOLOV5.utils import TryExcept
from HModel.YOLOV5.utils.dataloaders import exif_transpose, letterbox
...
from HModel.YOLOV5.utils.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights="yolov5s.pt", device=torch.device("cpu"), dnn=False, data=None, fp16=False, fuse=True):
        ...
        from HModel.YOLOV5.models.experimental import attempt_download, attempt_load  # scoped to avoid circular import
    ...
    def _model_type(p="path/to/model.pt"):
        ...
        from HModel.YOLOV5.export import export_formats
        from HModel.YOLOV5.utils.downloads import is_url
