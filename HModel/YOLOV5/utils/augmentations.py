...
from HModel.YOLOV5.utils.general import LOGGER, check_version, colorstr, resample_segments, segment2box, xywhn2xyxy
from HModel.YOLOV5.utils.metrics import bbox_ioa
